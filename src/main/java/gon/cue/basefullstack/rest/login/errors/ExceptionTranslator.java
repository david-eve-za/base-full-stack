package gon.cue.basefullstack.rest.login.errors;

import gon.cue.basefullstack.config.Constants;
import gon.cue.basefullstack.service.login.UsernameAlreadyUsedException;
import gon.cue.basefullstack.util.HeaderUtil;
import gon.cue.basefullstack.util.ProblemDetailWithCause;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (ex instanceof gon.cue.basefullstack.service.login.EmailAlreadyUsedException)
        ...
        if (ex instanceof UsernameAlreadyUsedException)
            return new LoginAlreadyUsedException()
                    .getProblemDetailWithCause();
        if (
                ex instanceof gon.cue.basefullstack.service.login.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "gon.cue.personalapp");
    }
}
